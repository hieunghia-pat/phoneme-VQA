...
def is_Vietnamese(word: str) -> tuple[bool, tuple]:
    ...
    if nucleus in ["oo", "ươ", "uô", "iê", "yê"] and coda is None:
        return False, None
    
    if nucleus == "ya" and medial is None:
        return False, None
    ...
    if coda == "u" and nucleus in ["i", "e", "ơ", "o", "ô", "y", "ia", "ya", "oo", "ưa", "ă"]:
        return False, None
...
def compose_word(onset: str, medial: str, nucleus: str, coda: str, tone: str) -> str:
    ...
    if tone in tone_map:
        ...
        # process for the special case of medial + coda (hỏa, thủy, thuở, thỏa, huề, ...)
        # in this case, "thuở", "huế", "huệ" follows the general rule of tone marking, the others are the case that tones are marked on the medial.
        ...
        assert tone == "<blank>" or tone is None, f"Received tone {tone}"
