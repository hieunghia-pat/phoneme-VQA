...
class LaTr_Executor(Base_Executor):
    ...
    def _create_data_utils(self):
        ...
        self.train_data = LaTrDataset(base_img_path = self.config.base_img_path,
                                        qa_df = train_qa_df,
                                        ocr_df = ocr_df,
    ...
    def _init_eval_predict_mode(self):
        ...
        if self.mode == "eval":
            ...
            self.predict_data = LaTrDataset(base_img_path = self.config.base_img_path,
                                                qa_df = predict_qa_df,
                                                ocr_df = ocr_df,
                                                tokenizer = self.tokenizer,
                                                max_ocr = self.config.max_ocr,
